...
//	have animation basis, need to add in spider walking. For now just left spider continue animation of walking even when eating a plant
//	firePlants should be healed by HealBoxes, also fires up the plant so that it is ready to fire
//	Sound Effects
...
//	when spiders try to eat fire plant, have the fire plant lose a life and the spider explode(too spicy)
//==========
//
